                ...
                <div className="home-page">
                    ...
                    <div className="demo-grid">
                        <div className="container home-centre">
                            ...
                            <p className="home-instructions">Congratulations! You're on a journey to glory and riches by dashing through dungeons. There a pitfalls to avoid and monsters to dodge, but always treasure somewhere inside. You can hear ambient sound with the buttton in the bottom right of the screen.</p>
